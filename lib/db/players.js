...
async function allPlayersForGameday(season, gameday) {
	return await all(
		...
		FROM DATA.rosters_from_timestamp(DATA.timestamp_from_gameday($1, $2)) r
		JOIN DATA.teams_from_timestamp(DATA.timestamp_from_gameday($1, $2)) t
		ON (r.team_id = t.team_id)
		JOIN DATA.players_from_timestamp(DATA.timestamp_from_gameday($1, $2)) p
